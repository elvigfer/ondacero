<template>
  <div class="player">
    <!-- song details -->
    <img :src="song.cover" alt="cover" class="portada">
    ...
    <div class="controls">
      <button class="btn_control" disabled>
        <img src="/shuffle.png" alt="Aleatorio">
      </button>
      <button class="btn_control" disabled>
      ...
      <button
        ...
        @click="playpause">
          <img v-show="!isPlaiying" src="play_verde.svg">
          <img v-show="isPlaiying" src="pause.svg">
      </button>
      <button class="btn_control" disabled>
  ...
  data(){
    return{
      ...
      song: {
        ...
        author: "Título podcast",
        cover: "/actualidad-imagen.png",
